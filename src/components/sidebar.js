...
import { isFeatureAvailable, isQingchenAssistantHidden } from '../lib/feature-gates.js'
...
function NAV_ITEMS_FULL() { return [
  {
    ...
    items: [
      ...
      ...(isQingchenAssistantHidden() ? [] : [{ route: '/assistant', label: t('sidebar.assistant'), icon: 'assistant' }]),
